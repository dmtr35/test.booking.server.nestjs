...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose.Schema.Types.ObjectId, ref: () => doctor_schema_1.Doctor }),
    __metadata("design:type", mongoose.Schema.Types.ObjectId)
], Appointment.prototype, "doctorId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Date, default: new Date(Date.now() + (3600 * 1000 * 24)) }),
    __metadata("design:type", String)
], Appointment.prototype, "date", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: false }),
    __metadata("design:type", Boolean)
], Appointment.prototype, "active", void 0);
